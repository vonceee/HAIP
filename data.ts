      ...
      },
      {
        ...
        content: `
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start h-[calc(100vh-250px)] relative">
             ...
             <div class="h-full relative overflow-hidden rounded-3xl bg-black/20 border border-white/5 group/scroller auto-scroll-container overflow-y-auto custom-scrollbar">
                 <div class="space-y-6 px-4 py-6">
                    <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 transition-colors group/image cursor-pointer relative shadow-lg hover:border-emerald-500/30">
  ...
  },
  {
    ...
    sections: [
          ...
          <div class="flex flex-col items-center justify-center min-h-full py-10">
            <div class="bg-cyan-950/40 border-4 border-cyan-500/20 p-8 rounded-[3rem] max-w-4xl w-full text-center backdrop-blur-md shadow-2xl hover:scale-105 transition-transform duration-700">
               ...
               <div class="bg-black/30 p-6 rounded-[2rem] italic text-lg text-cyan-200 font-quicksand">
                 ...
                 <div class="text-sm font-bold text-cyan-500 mt-2 not-italic font-fredoka uppercase tracking-widest">— NDRRMC</div>
               </div>
            </div>
          </div>
        `
      },
      {
        ...
        content: `
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 h-full items-start">
             <div class="bg-white/5 p-8 rounded-[2.5rem] border-2 border-white/10 h-full flex flex-col justify-start hover:border-blue-400 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)]">
                <h3 class="text-3xl font-fredoka font-black text-white mb-6 uppercase flex items-center">
                   <span class="bg-blue-500/20 p-3 rounded-2xl mr-3 animate-bounce"><svg class="w-8 h-8 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg></span>
                   Natural Signs
                </h3>
                <ul class="space-y-4 text-xl text-slate-200 font-quicksand font-bold">
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-500 mr-3 text-2xl group-hover:rotate-12 transition-transform">🌊</span> Sudden drop in air pressure & increased humidity</li>
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-500 mr-3 text-2xl group-hover:rotate-12 transition-transform">☁️</span> Dark, thick clouds in the eastern sky</li>
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-500 mr-3 text-2xl group-hover:rotate-12 transition-transform">💨</span> Strong winds shifting directions rapidly</li>
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-500 mr-3 text-2xl group-hover:rotate-12 transition-transform">🌧️</span> Continuous heavy rain</li>
                </ul>
             </div>
             <div class="bg-blue-900/30 p-8 rounded-[2.5rem] border-2 border-blue-500/30 h-full flex flex-col justify-start hover:bg-blue-900/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(30,64,175,0.4)]">
                <h3 class="text-3xl font-fredoka font-black text-blue-300 mb-6 uppercase flex items-center">
                   <span class="bg-blue-500/20 p-3 rounded-2xl mr-3 animate-spin"><svg class="w-8 h-8 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg></span>
                   Scientific Forecasting
                </h3>
                <ul class="space-y-4 text-xl text-blue-100 font-quicksand font-bold">
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-400 mr-3 text-2xl">📡</span> PAGASA satellite images showing spiral clouds</li>
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-400 mr-3 text-2xl">📢</span> Weather bulletins announcing depressions</li>
                   <li class="flex items-start group hover:translate-x-2 transition-transform"><span class="text-blue-400 mr-3 text-2xl">⚠️</span> Warning signals (Signal Nos. 1–5)</li>
                </ul>
                <div class="mt-8 p-6 bg-black/30 rounded-2xl text-base text-slate-300 italic font-quicksand border border-blue-500/20">
      ...
      },
      {
        ...
        content: `
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 h-full items-start">
             <div class="bg-white/5 p-8 rounded-[3rem] border-2 border-white/10 h-full flex flex-col justify-start hover:border-cyan-400 transition-all duration-500 hover:scale-105">
                <h3 class="text-4xl font-fredoka font-black text-white mb-6 uppercase drop-shadow-md">Natural Signs</h3>
                <ul class="space-y-4 text-xl text-slate-200 font-quicksand font-bold">
                   <li class="p-3 bg-white/5 rounded-xl hover:bg-cyan-500/20 transition-colors">Continuous heavy rainfall for hours</li>
                   <li class="p-3 bg-white/5 rounded-xl hover:bg-cyan-500/20 transition-colors">Rising water levels in rivers and creeks</li>
                   <li class="p-3 bg-white/5 rounded-xl hover:bg-cyan-500/20 transition-colors">Overflowing canals or drainage</li>
                   <li class="p-3 bg-white/5 rounded-xl hover:bg-cyan-500/20 transition-colors">Soil softening or water seeping from ground</li>
                </ul>
             </div>
             <div class="bg-cyan-900/30 p-8 rounded-[3rem] border-2 border-cyan-500/30 h-full flex flex-col justify-start hover:bg-cyan-900/50 transition-all duration-500 hover:scale-105">
                <h3 class="text-4xl font-fredoka font-black text-cyan-300 mb-6 uppercase drop-shadow-md">Scientific Signs</h3>
                <ul class="space-y-4 text-xl text-cyan-100 font-quicksand font-bold">
                   <li class="p-3 bg-cyan-950/40 rounded-xl border border-cyan-500/30">PAGASA rainfall radar (>50mm/hr)</li>
                   <li class="p-3 bg-cyan-950/40 rounded-xl border border-cyan-500/30">Color-coded warnings (Yellow, Orange, Red)</li>
                   <li class="p-3 bg-cyan-950/40 rounded-xl border border-cyan-500/30">Flood forecasting system alerts</li>
                </ul>
             </div>
          </div>
        `
      },
      {
        ...
        content: `
          <div class="flex flex-col h-full justify-start space-y-8">
             <div class="bg-indigo-900/40 border-4 border-indigo-500/30 p-10 rounded-[3rem] shadow-2xl">
                <h3 class="text-4xl md:text-5xl font-fredoka font-black text-indigo-300 mb-8 uppercase text-center drop-shadow-lg">Natural Signs</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-xl text-slate-200 font-quicksand font-bold">
                   <div class="bg-black/30 p-6 rounded-3xl hover:bg-indigo-600/40 transition-colors duration-300 hover:-translate-y-2 cursor-default">Unusually calm sea followed by sudden rise</div>
                   <div class="bg-black/30 p-6 rounded-3xl hover:bg-indigo-600/40 transition-colors duration-300 hover:-translate-y-2 cursor-default">Strong winds blowing toward shore</div>
                   <div class="bg-black/30 p-6 rounded-3xl hover:bg-indigo-600/40 transition-colors duration-300 hover:-translate-y-2 cursor-default">Rapidly receding shoreline</div>
                   <div class="bg-black/30 p-6 rounded-3xl hover:bg-indigo-600/40 transition-colors duration-300 hover:-translate-y-2 cursor-default">Dark clouds near the coast</div>
                </div>
             </div>
             <div class="bg-black/30 p-8 rounded-[2rem] border-l-8 border-indigo-500 hover:scale-[1.02] transition-transform duration-500">
        ...
        content: `
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start h-[calc(100vh-250px)] relative">
             ...
             <div class="flex flex-col justify-start h-full lg:px-12 py-2">
                 <div class="space-y-8">
                    <div>
                       <h3 class="text-4xl md:text-5xl font-fredoka font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 to-stone-500 mb-4 uppercase transition-all duration-500 hover:tracking-widest cursor-default drop-shadow-lg">Landslide Signs</h3>
                       <p class="text-2xl text-slate-300 font-quicksand font-bold">triggered by intense rainfall.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                       <div class="bg-stone-900/40 p-6 rounded-[2rem] border-2 border-stone-600/30 hover:bg-stone-800/40 transition-all duration-300 hover:scale-[1.02] group cursor-pointer hover:border-stone-400">
                          <h4 class="text-stone-300 font-fredoka font-bold uppercase mb-4 text-2xl group-hover:text-white">Natural Indicators</h4>
                          <ul class="space-y-3 text-slate-300 font-quicksand text-lg font-bold">
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-white/5 rounded-lg">• Cracks appearing on ground or walls</li>
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-white/5 rounded-lg">• Tilting of trees or poles</li>
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-white/5 rounded-lg">• Sudden appearance of muddy springs</li>
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-white/5 rounded-lg">• Rumbling sounds from slopes</li>
                          </ul>
                       </div>
                       <div class="bg-emerald-900/30 p-6 rounded-[2rem] border-2 border-emerald-500/30 hover:bg-emerald-800/30 transition-all duration-300 hover:scale-[1.02] group cursor-pointer hover:border-emerald-400">
                          <h4 class="text-emerald-300 font-fredoka font-bold uppercase mb-4 text-2xl group-hover:text-emerald-200">Scientific Indicators</h4>
                          <ul class="space-y-3 text-emerald-100 font-quicksand text-lg font-bold">
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-emerald-900/40 rounded-lg">• Soil moisture saturation sensors</li>
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-emerald-900/40 rounded-lg">• Rainfall threshold exceeded</li>
                             <li class="hover:translate-x-2 transition-transform p-2 hover:bg-emerald-900/40 rounded-lg">• Ground deformation monitoring</li>
                          </ul>
                       </div>
                    </div>
                 </div>
             ...
             <div class="h-full relative overflow-hidden rounded-[2rem] bg-black/20 border border-white/5 group/scroller auto-scroll-container overflow-y-auto custom-scrollbar">
                 <div class="space-y-6 px-4 py-6">
                    <div class="bg-white/5 border-2 border-white/10 rounded-[2rem] overflow-hidden hover:bg-white/10 transition-colors group/image cursor-pointer relative shadow-lg hover:border-emerald-400">
                        ...
                        <div class="p-6">
                           <p class="text-base text-slate-200 font-bold mb-1 font-quicksand">Maco, Davao de Oro Landslide</p>
                        </div>
                    </div>
                    <div class="bg-white/5 border-2 border-white/10 rounded-[2rem] overflow-hidden hover:bg-white/10 transition-colors group/image cursor-pointer relative shadow-lg hover:border-emerald-400">
                        <div class="h-56 overflow-hidden relative">
                    ...
                    <div class="bg-white/5 border-2 border-white/10 rounded-[2rem] overflow-hidden hover:bg-white/10 transition-colors group/image cursor-pointer relative shadow-lg hover:border-emerald-400">
                        ...
                        <div class="p-6">
                           <p class="text-base text-slate-200 font-bold mb-1 font-quicksand">Guinsaugon, Southern Leyte Catastrophe</p>
                        </div>
                    </div>
                 </div>
             </div>
      ...
      },
      {
        ...
        content: `
          <div class="flex flex-col h-full justify-start space-y-8">
             <div class="bg-orange-900/30 border-4 border-orange-500/20 p-10 rounded-[3rem] text-center shadow-2xl hover:scale-105 transition-transform duration-700">
                <h3 class="text-5xl font-fredoka font-black text-orange-300 mb-8 uppercase drop-shadow-lg">Drought Signs</h3>
                <div class="grid grid-cols-2 gap-6 text-left text-xl text-slate-200 font-quicksand font-bold">
                   <div class="p-4 bg-orange-950/40 rounded-2xl hover:bg-orange-800/40 transition-colors">• Prolonged dry/hot days</div>
                   <div class="p-4 bg-orange-950/40 rounded-2xl hover:bg-orange-800/40 transition-colors">• Wilting crops and grass</div>
                   <div class="p-4 bg-orange-950/40 rounded-2xl hover:bg-orange-800/40 transition-colors">• Drying of small water bodies</div>
                   <div class="p-4 bg-orange-950/40 rounded-2xl hover:bg-orange-800/40 transition-colors">• Dusty air</div>
                </div>
                <div class="mt-8 pt-6 border-t-2 border-orange-500/30 text-orange-200">
                   <p class="font-fredoka text-2xl font-bold mb-2">Scientific: El Niño Advisory</p>
                   <p class="text-base opacity-90 font-quicksand">Decreased water levels in dams (e.g., Angat Dam).</p>
                </div>
             </div>
          </div>
        `
      ...
      },
      {
        ...
        content: `
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start h-[calc(100vh-250px)] relative">
             ...
             <div class="h-full relative overflow-hidden rounded-[2rem] bg-black/20 border-2 border-white/5 group/scroller auto-scroll-container overflow-y-auto custom-scrollbar">
                 <div class="space-y-6 px-4 py-6">
